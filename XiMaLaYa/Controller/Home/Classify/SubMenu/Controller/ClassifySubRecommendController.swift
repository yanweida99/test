...
class ClassifySubRecommendController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        // - 注册头视图和尾视图
        collection.register(ClassifySubHeaderView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: ClassifySubHeaderViewID)
        collection.register(ClassifySubFooterView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: ClassifySubFooterViewID)
