...
struct PlayModel:HandyJSON {
    var ret: Int = 0
    var albumInfo:PlayAlbumInfo?
    var associationAlbumsInfo: [PlayAssociationAlbumsInfo]?
    var noCacheInfo:PlayNoCacheInfo?
    var trackInfo:PlayTrackInfo?
    var userInfo:PlayUserInfo?
}

struct PlayAlbumInfo:HandyJSON {
    var albumId: Int = 0
...
struct PlayAssociationAlbumsInfo:HandyJSON {
    var isDraft:Bool = false
    var albumId: Int = 0
    var uid: Int = 0
    var updatedAt: Int = 0
...
struct PlayNoCacheInfo:HandyJSON {
    var recAlbumsPanelTitle: String?
    var associationAlbumsInfo: [PlayAssociationAlbumsInfo]?
    var communityInfo:PlayCommunityInfo?
    var commentInfo:PlayCommentInfoList?
}
struct PlayCommentInfoList:HandyJSON {
    var list: [PlayCommentInfo]?
}
struct PlayCommentInfo:HandyJSON {
    var createdAt: Int = 0
    var id: Int = 0
    var likes: Int = 0
...
struct PlayCommunityInfo:HandyJSON {
...
struct PlayTrackInfo:HandyJSON {
    var albumId: Int = 0
