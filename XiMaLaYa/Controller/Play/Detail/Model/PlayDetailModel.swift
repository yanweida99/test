...
// 播放列表详情页数据模型
struct PlayDetailModel:HandyJSON {
    var album:PlayDetailAlbumModel?
    var user:PlayDetailUserModel?
    var tracks:PlayDetailTracksModel?
...
struct PlayDetailAlbumModel:HandyJSON {
    var albumId:Int = 0
...
struct PlayDetailUserModel:HandyJSON {
    var uid:Int = 0
    var nickname:String?
    var isVerified:Bool = false
...
struct PlayDetailTracksModel:HandyJSON {
    var list:[PlayDetailTracksListModel]?
}

struct PlayDetailTracksListModel:HandyJSON {
    var trackId:Int = 0
    var uid:Int = 0
    var duration:Int = 0
    var albumId:Int = 0
